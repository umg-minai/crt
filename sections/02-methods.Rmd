...
CRT occurrence in critically ill patients with CVCs that were treated
in our surgical intensive care unit (ICU)
...
The choice of the appropriate CVC type, site and side were made by the clinicians performing the placement.
They were asked to complete a questionnaire documenting the manufacturer, the LOT (identification) number, the number of attempts, any complications and their level of expertise in the placement of CVCs.
...
CRT was diagnosed when an echogenic structure attached to the CVC was detected that was non-compressible and showed pathological color Doppler.
...
The findings obtained in these investigations that were performed outside of routine care were not reported to the treating clinicians to not alter the usual care.
...
Further we observed the three-lumen Certofix protect trio (B. Braun SE, Germany), consisting of a siliconized polyurethane, embedded barium sulfate contrast agent and an
antiseptic polyhexamethylene biguanide coating (polyhexanide; referred as Braun3), and
the five-lumen multicath CVC (VYGON GmbH & Co. KG, Germany; referred as Vygon5), made of polyurethane without any special coating.

## Outcome

The primary outcome was the time of onset of CRT for each type of CVC.
As the reported CRT rates were very inhomogeneous, we planned our study as an
...
Multiple testing was corrected by applying the Benjamini-Hochberg procedure [@Benjamini1995].
...
All data and analyses can be found at https://github.com/umg-minai/crt **TODO** (add zenodo citation link).
