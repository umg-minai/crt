...
```{r forestplotlots, echo = FALSE, fig.width = 12, fig.height = 12, fig.cap = "Hazard ratios for all central venous catheters assuming missing LOTs where major types of each manufacturer."}
ggforest(rgcx.lots, data = rd.lots)
```

```{r forestplotfull, echo = FALSE, fig.width = 12, fig.height = 12, fig.cap = "Hazard ratios for all available variables but with reduced sample size."}
ggforest(rgcx.full, data = rd.na)
```
