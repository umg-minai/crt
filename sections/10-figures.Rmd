...
```{r forestplot, echo = FALSE, fig.width = 12, fig.height = 8, fig.cap = "Hazard ratios. DVT, deep venous thrombosis; LMWH, low-molecular-weighted heparins; UFH, unfractionated heparin; WBC1, white blood count on day one."}
.ggforest(
    rgcx, data = rd,
    rename = c(
        ManLu = "Type",
