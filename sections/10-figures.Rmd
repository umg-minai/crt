...
```{r consort-flowchart, echo = FALSE, fig.width = 12, fig.cap = "The flowchart depicts the inclusion and exclusion criteria. CVC, central venous catheter; FV, femoral vein; SCV, subclavian vein."}
library("consort")
