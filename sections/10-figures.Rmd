...
```{r consort-flowchart, echo = FALSE, fig.width = 12, fig.cap = "The flowchart depicts the inclusion and exclusion criteria. CVC, central venous catheter; DOAC, direct oral anticoagulants; FV, femoral vein; SCV, subclavian vein."}
library("consort")
...
```{r survplot, echo = FALSE, fig.width = 12, fig.height = 8, fig.cap = "Survival plot showing CRT-free time for all analysed central venous catheters. The confidence intervals are overlapping and were not drawn for easier visualization."}
...
```{r forestplot, echo = FALSE, fig.width = 12, fig.height = 8, fig.cap = "Hazard ratios of CRT adjusted for different covariates. CRT, catheter-related thrombosis; CVC, central venous catheter; DVT, deep venous thrombosis; LMWH, low-molecular-weighted heparins; UFH, unfractionated heparin; WBC1, white blood count on day one."}
.ggforest(
    rgcx, data = rd,
    rename = rgcx.nms
)
