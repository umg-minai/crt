...
```{r crtheightbp, fig.width = 15, fig.height = 10, echo = FALSE, fig.cap = "Boxplots of catheter-related thrombosis height over time."}
...
```{r crtheightovertime, fig.width = 15, fig.height = 10, echo = FALSE, fig.cap = "Catheter-related thrombosis height over time."}
.crtovertime(
    droplevels(cvc[!cvc$isExcluded, c("Id", "ManLu", paste0("Height", 1:17))]),
    col = cols,
    ylab = "THROMBOSIS HEIGHT [mm]"
...
```{r crtwidthbp, fig.width = 15, fig.height = 10, echo = FALSE, fig.cap = "Boxplots of catheters-related thrombosis width over time."}
.crtplots(
...
```{r crtwidthovertime, fig.width = 15, fig.height = 10, echo = FALSE, fig.cap = "Catheters-related thrombosis width over time."}
.crtovertime(
    droplevels(cvc[!cvc$isExcluded, c("Id", "ManLu", paste0("Width", 1:17))]),
    col = cols,
    ylab = "THROMBOSIS WIDTH [mm]"
...
```{r pha-plot, echo = FALSE, fig.width = 12, fig.height = 12, fig.cap = "Scaled Schoenfeld residuals over transformed time for each covariate. Depicted $p$-values were calculated applying chi-square independence test. CVC, central venous catheters; DVT, deep vein thrombosis; WBC1, white blood count on day one."}
ggcoxzph(pha, df = 2)
```
...
```{r forestplotlots, echo = FALSE, fig.width = 12, fig.height = 12, fig.cap = "Hazard ratios of CRT for all central venous catheters assuming that missing LOTs were of each manufacturer's main type. DVT, deep vein thrombosis; LMWH, low-molecular-weight heparins; UFH, unfractionated heparin; WBC1, white blood cell count on day one."}
.ggforest(
    rgcx.lots,
    data = rd.lots,
    rename = rgcx.nms
...
knitr::kable(
    lottbl,
    col.names = c(
        "Id", "MF", "Type", "LM", "LOT", "PN", "EXCL"
    ),
    caption = paste0(
        "LOT and part numbers (PN) of examined central venous catheters.",
        " EXCL: Excluded, LM: Lumens, MF: Manufacturer, PN: part number."
    )
)
```
