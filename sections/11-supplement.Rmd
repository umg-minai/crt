...
```{r crtwidthbp, fig.width = 15, fig.height = 10, echo = FALSE, fig.cap = "Boxplots of catheter-related thrombosis width over time."}
.crtplots(
...
```{r crtwidthovertime, fig.width = 15, fig.height = 10, echo = FALSE, fig.cap = "Catheter-related thrombosis width over time."}
.crtovertime(
    droplevels(cvc[!cvc$isExcluded, c("Id", "ManLu", paste0("Width", 1:17))]),
    col = cols,
    ylab = "THROMBOSIS WIDTH [mm]"
