...
```{r crtheightbp, fig.width = 15, fig.height = 10, echo = FALSE, fig.cap = "Boxplots of CRT height"}
...
```{r crtwidthbp, fig.width = 15, fig.height = 10, echo = FALSE, fig.cap = "Boxplots of CRT width"}
.crtplots(
...
```{r pha-plot, echo = FALSE, fig.width = 12, fig.height = 12, fig.cap = "Scaled Schoenfeld residuals over transformed time for each covariate. Depicted $p$-values were calculated applying chi-square independence test."}
ggcoxzph(pha, df = 2)
```
...
tbl_regression(rgcx, exponentiate = TRUE) |>
    modify_caption(
        paste0(
            "Hazard ratios for Cox regression on all N=", rgcx$n,
...
tbl_regression(rgcx.lots, exponentiate = TRUE) |>
    modify_caption(
        paste0(
            "Hazard ratios for Cox regression using assuming that ",
...
tbl_regression(rgcx.full, exponentiate = TRUE) |>
    modify_caption(
        paste0(
            "Hazard ratios for Cox regression using all available variables ",
...
```{r survplota5v5, echo = FALSE, fig.width = 12, fig.height = 7, fig.cap = "Survival plot showing CRT-free time for 5 lumen central venous catheters."}
...
```{r survplota4a5, echo = FALSE, fig.width = 12, fig.height = 7, fig.cap = "Survival plot showing CRT-free time for 4 and 5 lumen central venous catheters."}
xlim <- c(0.8, max(times))
mar <- c(0.1, 10.1, 1.1, 2.1)
