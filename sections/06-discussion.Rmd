...
Thus, our results support the guideline recommendation to leave catheters with CRT in place [@Kearon2012; @Wall2015].
...
However, the early removal of CVCs regardless of visible CRTs is of major importance to ensure venous blood flow and reduce serious adverse events.
Nevertheless the need for therapeutic anticoagulation in asymptomatic incidental should be debated.
...
This may have led to an underestimation of the incidence of CRT as a recent autopsy study found most of the CRTs at the catheter tip [@Rockholt2024].
