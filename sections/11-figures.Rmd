...
```{r consort-flowchart, echo = FALSE, warning = FALSE, dev = ifelse_is_docx("pdf", "png"), fig.width = 12, fig.cap = "The flowchart shows the inclusion and exclusion criteria. CVC, central venous catheter; DOAC, direct oral anticoagulants; FV, femoral vein; SCV, subclavian vein."}
library("consort")
