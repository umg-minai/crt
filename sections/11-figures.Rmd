...
```{r consort-flowchart, echo = FALSE, warning = FALSE, dev = ifelse_is_docx(c("tiff", "pdf"), "png"), fig.width = 14, fig.height = 7, fig.cap = "The flowchart shows the inclusion and exclusion criteria. CVC, central venous catheter; DOAC, direct oral anticoagulants; FV, femoral vein; SCV, subclavian vein."}
library("consort")
